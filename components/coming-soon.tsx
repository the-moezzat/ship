...
function ComingSoon() {
    return (
        <>
            <div className={'border rounded-2xl h-full p-4 pb-52'}>
            ...
            <div
                className={'absolute bg-black text-white text-base md:text-lg py-4 w-[150%] bottom-20 -left-5 rotate-6 text-nowrap'}>coming
            ...
            <div
                className={'absolute bg-black text-white text-base md:text-lg py-4 w-[150%] bottom-32 -left-5 -rotate-12 text-nowrap'}>coming
                soon. stay tuned coming soon. stay tuned coming soon. stay tuned coming soon. stay tuned coming soon.
                stay tuned
            </div>
        </>
